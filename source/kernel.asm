;SLOS --- The SLOS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE SLOS_VER '1.0.0'	 ;OS version number
	%DEFINE SLOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as SLOS and its programs
...
option_screen:
	...
	mov dx, 0			; We want a One-option dialog box (Display)
	call os_dialog_box

	cmp ax, 1			; If Display OK (option 0) chosen, start app selector
	...
	os_init_msg		db '*************************SLOS Operating System****************************', 0
	os_version_msg		db 'Version ', SLOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', SLOS_VER, 0

	dialog_string_1		db 'Welcome to SLOS Operating System', 0
	dialog_string_2		db 'Please select Display Button for Hardware', 0
	dialog_string_3		db 'Informatin.', 0
